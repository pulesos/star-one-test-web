...
const BuyCreditsPage = ({setModalActive, loggedIn, handleClick, products}) => {
    return (
        <>
            ...
            <Coins products={products} setModalActive={setModalActive} loggedIn={loggedIn} handleClick={handleClick}/>
            <h3 className="events__title">
